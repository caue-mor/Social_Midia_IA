...
def create_team() -> Team:
    ...
    team = Team(
        ...
        instructions=[
            "Voce e o roteador principal do AgenteSocial.",
            "Analise a mensagem do usuario e ROTEIE para o sub-team adequado.",
            "",
            "ROTEAMENTO:",
            "- Criar posts, legendas, carrosseis, textos, design visual, hashtags, plano de conteudo, pacote completo → Content Factory",
            ...
            "",
            "REGRAS CRITICAS:",
            "1. Roteie para exatamente 1 sub-team por mensagem.",
            "2. Se a mensagem envolver multiplas areas, roteie para Content Factory (prioridade de conteudo).",
